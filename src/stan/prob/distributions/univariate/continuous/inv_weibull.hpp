#ifndef __STAN__PROB__DISTRIBUTIONS__INV_WEIBULL_HPP__
#define __STAN__PROB__DISTRIBUTIONS__INV_WEIBULL_HPP__
...
namespace stan {
  ...
  namespace prob {
    ...
    // Inverse-Weibull(y|sigma,alpha)     [y >= 0;  sigma > 0;  alpha > 0]
    // FIXME: document
    template <bool propto,
              typename T_y, typename T_shape, typename T_scale>
    typename return_type<T_y,T_shape,T_scale>::type
    inv_weibull_log(const T_y& y, const T_shape& alpha, const T_scale& sigma) {
      static const char* function = "stan::prob::inv_weibull_log(%1%)";
    ...
    typename return_type<T_y,T_shape,T_scale>::type
    inv_weibull_log(const T_y& y, const T_shape& alpha, const T_scale& sigma) {
      return inv_weibull_log<false>(y,alpha,sigma);
    }

    template <typename T_y, typename T_shape, typename T_scale>
    typename return_type<T_y,T_shape,T_scale>::type
    inv_weibull_cdf(const T_y& y, const T_shape& alpha, const T_scale& sigma) {

      static const char* function = "stan::prob::inv_weibull_cdf(%1%)";
    ...
    template <typename T_y, typename T_shape, typename T_scale>
    typename return_type<T_y,T_shape,T_scale>::type
    inv_weibull_cdf_log(const T_y& y, const T_shape& alpha, const T_scale& sigma) {

      static const char* function = "stan::prob::inv_weibull_cdf_log(%1%)";
    ...
    template <typename T_y, typename T_shape, typename T_scale>
    typename return_type<T_y,T_shape,T_scale>::type
    inv_weibull_ccdf_log(const T_y& y, const T_shape& alpha, const T_scale& sigma) {

      static const char* function = "stan::prob::inv_weibull_ccdf_log(%1%)";
    ...
    template <class RNG>
    inline double
    inv_weibull_rng(const double alpha,
                const double sigma,
                RNG& rng) {
      using boost::variate_generator;
      using boost::random::weibull_distribution;

      static const char* function = "stan::prob::inv_weibull_rng(%1%)";
